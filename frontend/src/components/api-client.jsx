// api-client.jsx — client for the FastAPI /api/analysis/fit-curve endpoint.
//
// Uses relative URLs: in dev the Vite proxy forwards /api/* → http://localhost:8000;
// in the production web build, /api/* is served from the same origin as the React app;
// in Electron, the bundled sidecar serves on a known port and the renderer's
// window-level base URL points to it. One client, three transports.
  ...
  return (
    <div className="card" style={{ marginBottom: 14 }}>
      ...
      <div style={{ padding: 14, fontSize: 12, color: "var(--ink-3)" }}>
        ...
        <code>localhost:8000</code> (proxied by Vite from <code>/api</code>).
      </div>
